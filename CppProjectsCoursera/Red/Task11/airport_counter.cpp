...
template <typename TAirport, const size_t N = static_cast<size_t>(TAirport::Last_)>
...
public:
  ...
  void EraseOne(TAirport airport) { if (data[static_cast<size_t>(airport)] != 0) --data[static_cast<size_t>(airport)]; }
