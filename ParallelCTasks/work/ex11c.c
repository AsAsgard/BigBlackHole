...
double k(double x);
double k(double x) {
  return exp(-5.0*(x - xa)/(xb - xa));
}

double k1(double x);
double k1(double x) {
  return -5.0/(xb - xa) * exp(-5*(x - xa)/(xb - xa));
}

double q(double x);
double q(double x) {
  return 1.0 - 0.5 * sin(10*(x - xa)/(xb - xa));
}

double u(double x);
double u(double x) {
  return ua - ub/(2*px) * sin(2*px*(x - xa));
}

double u1(double x);
double u1(double x) {
  return -ub * cos(2*px*(x - xa));
}

double u2(double x);
double u2(double x) {
  return ub*2*px * sin(2*px*(x - xa));
}
